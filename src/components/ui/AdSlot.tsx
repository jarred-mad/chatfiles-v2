...
'use client';                                                                               
  ...
  // Default AdSlot                                                                           
  export default function AdSlot({ className = '', id, size }: { className?: string; id?:     
  string; size?: string }) {                                                                  
  ...
  export function LeaderboardAd({ className = '' }: { className?: string }) {                 
    ...
    useEffect(() => {                                                                         
      ...
      invokeScript.src =                                                                      
  'https://www.highperformanceformat.com/a93a7e8aeab3342ce1628214611315f8/invoke.js';         
  ...
  export function SidebarAd({ className = '' }: { className?: string }) {                     
    ...
    useEffect(() => {                                                                         
      ...
      invokeScript.type = 'text/javascript';                                                  
      invokeScript.src =                                                                      
  'https://www.highperformanceformat.com/6ea2a3d08ec0f485f70f464045a48a80/invoke.js';         
      container.appendChild(invokeScript);                                                    
    }, [adId]);                                                                               
                                                                                              
    return (                                                                                  
      <div ref={adRef} id={adId} className={`ad-container ${className}`} style={{ width: 300, 
  minHeight: 250 }}>                                                                          
      </div>                                                                                  
    );                                                                                        
  }                                                                                           
  ...
  export function SkyscraperAd({ className = '' }: { className?: string }) {                  
    ...
    useEffect(() => {                                                                         
      ...
      invokeScript.type = 'text/javascript';                                                  
      invokeScript.src =                                                                      
  'https://www.highperformanceformat.com/b4f0e68ec325d0e8ae6160bd9cb72d26/invoke.js';         
      container.appendChild(invokeScript);                                                    
    }, [adId]);                                                                               
                                                                                              
    return (                                                                                  
      <div ref={adRef} id={adId} className={`ad-container ${className}`} style={{ width: 160, 
  minHeight: 300 }}>                                                                          
      </div>                                                                                  
    );                                                                                        
  }                                                                                           
  ...
  export function BannerAd468({ className = '' }: { className?: string }) {                   
    ...
    useEffect(() => {                                                                         
      ...
      invokeScript.type = 'text/javascript';                                                  
      invokeScript.src =                                                                      
  'https://www.highperformanceformat.com/1e03506bd1599ceabdf2f622ed71e1f4/invoke.js';         
      container.appendChild(invokeScript);                                                    
    }, [adId]);                                                                               
                                                                                              
    return (                                                                                  
      <div ref={adRef} id={adId} className={`ad-container flex justify-center my-4            
  ${className}`} style={{ minHeight: 60 }}>                                                   
      </div>                                                                                  
    );                                                                                        
  }                                                                                           
  ...
  export function WideSkyscraperAd({ className = '' }: { className?: string }) {              
    ...
    useEffect(() => {                                                                         
      ...
      invokeScript.type = 'text/javascript';                                                  
      invokeScript.src =                                                                      
  'https://www.highperformanceformat.com/36179abb943aa71a84f3df1312de97d4/invoke.js';         
      container.appendChild(invokeScript);                                                    
    }, [adId]);                                                                               
  ...
  export function MobileBannerAd({ className = '' }: { className?: string }) {                
    ...
    useEffect(() => {                                                                         
      ...
      invokeScript.type = 'text/javascript';                                                  
      invokeScript.src =                                                                      
  'https://www.highperformanceformat.com/268ccc0aa6d01fd38fcf6d1521f57c7f/invoke.js';         
      container.appendChild(invokeScript);                                                    
    }, [adId]);                                                                               
  ...
  export function HilltopAdBanner1({ className = '' }: { className?: string }) {              
    ...
    useEffect(() => {                                                                         
      if (!adRef.current || adRef.current.querySelector('script')) return;                    
      trackImpression('hilltopads', 'banner1');                                               
                                                                                              
      const container = adRef.current;                                                        
      const script = document.createElement('script');                                        
      script.async = true;                                                                    
      script.referrerPolicy = 'no-referrer-when-downgrade';                                   
      script.src = '//lucky-throat.com/bYXxV/s.dpGClY0BYiWVcQ/beZm-9RuiZDU/lGkjPaTMYO3qNuzsYw5
  IMVjJkBtANKj/cz3zNijIkezBM/wN';                                                             
      container.appendChild(script);                                                          
    }, [adId]);                                                                               
  ...
  export function HilltopAdBanner2({ className = '' }: { className?: string }) {              
    ...
    useEffect(() => {                                                                         
      if (!adRef.current || adRef.current.querySelector('script')) return;                    
      trackImpression('hilltopads', 'banner2');                                               
                                                                                              
      const container = adRef.current;                                                        
      const script = document.createElement('script');                                        
      script.async = true;                                                                    
      script.referrerPolicy = 'no-referrer-when-downgrade';                                   
      script.src = '//lucky-throat.com/bXXYV_sod.GClv0mYeWhcB/seImA9huHZ/U/lEk/P/TbYw3vNJzTYN5
  INnDvUEtcN/jZcj3lNwjukl0UOCQy';                                                             
      container.appendChild(script);                                                          
    }, [adId]);                                                                               
  ...
  export function HilltopAdBanner3({ className = '' }: { className?: string }) {              
    ...
    useEffect(() => {                                                                         
      if (!adRef.current || adRef.current.querySelector('script')) return;                    
      trackImpression('hilltopads', 'banner3');                                               
                                                                                              
      const container = adRef.current;                                                        
      const script = document.createElement('script');                                        
      script.async = true;                                                                    
      script.referrerPolicy = 'no-referrer-when-downgrade';                                   
      script.src = '//lucky-throat.com/bMXFV.smdkGklj0/YLW-cy/be/mh9Lu/ZUUvlxkQPYTkY/3UNjz-Eay
  lMBjUE/thNEjOcQ3UM-TnImyqNCQj';                                                             
      container.appendChild(script);                                                          
    }, [adId]);                                                                               
  ...
  export function HilltopAdBanner4({ className = '' }: { className?: string }) {              
    ...
    useEffect(() => {                                                                         
      if (!adRef.current || adRef.current.querySelector('script')) return;                    
      trackImpression('hilltopads', 'banner4');                                               
                                                                                              
      const container = adRef.current;                                                        
      const script = document.createElement('script');                                        
      script.async = true;                                                                    
      script.referrerPolicy = 'no-referrer-when-downgrade';                                   
      script.src = '//lucky-throat.com/beXYV.s/dlG-lk0LYpW/ch/AemmL9wuSZtUdl/kwPYT/Yc3rNJzRYZ5
  cN/D/UstCNDjbcd3oN/jhkD0MOyQd';                                                             
      container.appendChild(script);                                                          
    }, [adId]);                                                                               
  ...
  export function HilltopAdBanner5({ className = '' }: { className?: string }) {              
    ...
    useEffect(() => {                                                                         
      if (!adRef.current || adRef.current.querySelector('script')) return;                    
      trackImpression('hilltopads', 'banner5');                                               
                                                                                              
      const container = adRef.current;                                                        
      const script = document.createElement('script');                                        
      script.async = true;                                                                    
      script.referrerPolicy = 'no-referrer-when-downgrade';                                   
      script.src = '//lucky-throat.com/bgX.VNs/dVGNlN0vYWWfcc/oe_mh9OutZ/UklJkxPOTPYq3GNuzJYl5
  bMajJk_tXNLjBcA3_NwjNk/zOMTwH';                                                             
      container.appendChild(script);                                                          
    }, [adId]);                                                                               
  ...
  export function HilltopAdBanner6({ className = '' }: { className?: string }) {              
    ...
    useEffect(() => {                                                                         
      if (!adRef.current || adRef.current.querySelector('script')) return;                    
      trackImpression('hilltopads', 'banner6');                                               
                                                                                              
      const container = adRef.current;                                                        
      const script = document.createElement('script');                                        
      script.async = true;                                                                    
      script.referrerPolicy = 'no-referrer-when-downgrade';                                   
      script.src = '//lucky-throat.com/bfXaVRsxd.Gvl/0DYPWQcP/Tesm/9MuAZYUKlOkIPFT/YB3/NLzlEry
  QM_j/ETtBNgjIcT3vMWTsIjyoNQQE';                                                             
      container.appendChild(script);                                                          
    }, [adId]);                                                                               
